...
/// <summary>
///   <para>
///      Strongly typed business object that represents either of two
///      identifiers issued by the Swedish Tax Agency that have the same format
///      and are used for similar purposes. The first, the Personal Identity
///      Number (personnummer) is issued to persons born in Sweden or who are
///      residents of Sweden for 12 months or longer. The second, the
///      coordination number (samordningsnummer) is issued to persons who reside
///      in Sweden for less than a year. The <see cref="IdentifierType"/>
///      property will indicate the exact type of identifier represented by an
///      instance of <see cref="SeIdentityNumber"/>.
///   </para>
///   <para>
///      See <see cref="SePersonnummer"/> and <see cref="SeSamordningsnummer"/>
