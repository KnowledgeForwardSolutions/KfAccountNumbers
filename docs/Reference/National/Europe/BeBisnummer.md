...
A BIS number (bis-nummer or numéro bis) is the identifier issued to non-residents and individuals who are not recorded in Belgium's National Register (Rijksregister/Registre national).
...
* If the person's gender is unknown at the time the number is issued then **20** is added to the month component of the date of birth.
