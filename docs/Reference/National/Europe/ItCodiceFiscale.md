...
| Is composite: | No |
| Length: | 16 |
| Check digit algorithm: | Modulus 26 |
...
| 9. | The day of birth, character positions 9-10 (zero-based) must be two ASCII digits ('0'-'9') the or the equivalent Omocodia letter (see below). The integer value must be between 01-31 for males and 41-71 for females. The integer value must also be valid for the year/month | InvalidDay |
