...
| 10. | The town of birth, character positions 11-14 (zero-based) must be an upper-case or lower-case alphabetic character ('A'-'Z', 'a'-'z') followed by three ASCII digits ('0'-'9') the equivalent Omocodia letter (see below) | InvalidLocationCode |
