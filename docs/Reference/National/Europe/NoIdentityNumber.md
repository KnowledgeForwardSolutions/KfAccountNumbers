...
A H-nummer (hjelpenummer) is a temporary identifier issued by local health organizations (such as a hospital) to unidentified patients or tourists. A H-nummer is unique only within the issuing organization. A H-nummer is distinguished by a +40 offset added to the month component of the date of birth (1-12 becomes 41-52).
