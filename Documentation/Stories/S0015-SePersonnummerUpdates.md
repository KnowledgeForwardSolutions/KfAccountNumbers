...
* Change internal representation to 12 digits (YYYYMMDDBBBC, where BBB = 3 digit birth serial number and C = check digit). Store separator as boolean IsCentinarian flag.
