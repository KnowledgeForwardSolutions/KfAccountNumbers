...
- [x] The `GbNhsNumber` type represents a UK NHS Number
...
- [x] Total length is 10 digits (unformatted) or 12 characters (formatted with separators)
...
- [x] If separator characters present, must be at positions 3 and 7 (zero-based) forming pattern: NNN NNN NNNN
...
- [x] The first nine digits must be in one of the allowed ranges: 400 000 000 to 499 999 999 or 600 000 000 to 799 999 999 or 900 000 000 to 999 999 999 (900 series block reserved for testing purposes)
...
### Format Support
- [x] Accept unformatted: 1234567881
- [x] Accept formatted with separator characters: 123 456 7881
...
- [x] `IdentifierType` property returns a union of NhsNumber and TestNumber

### No Embedded Intelligence
- [x] NHS number does not encode date of birth
- [x] NHS number does not encode gender
- [x] NHS number does not encode geographic information
...
- [x] `ToString` returns raw value (10 digits, no separators)
- [x] Proper equality implementation (space-insensitive)
- [x] JSON serialization/deserialization support via `GbNhsNumberJsonConverter`

### Special Cases
- [x] Normalize separators during validation
- [x] Reject numbers where calculated check digit would be 10
- [x] Test numbers (900 million range) should validate but be identifiable via property

### Test Coverage
- [x] Valid NHS numbers with correct check digits
...
- [x] Standard number range (400 000 000 to 499 999 999 or 600 000 000 to 799 999 999)
...
- [x] Separator normalization efficient
