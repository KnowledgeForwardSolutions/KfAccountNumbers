...
public class CaSocialInsuranceNumberTests
{
   ...
   [InlineData("100 100 007")]
   [InlineData("110 000 007")]
   public void CaSocialInsightsNumber_ValidateWithCustomSeparator_ShouldCorrectlyWeightOddPositionCharacters_WhenCalculatingLuhnCheckDigit(String sin)
      => CaSocialInsuranceNumber.Validate(sin, CustomSeparator).Should().Be(CaSocialInsuranceNumberValidationResult.ValidationPassed);
   ...
   [InlineData("101 000 008")]
   [InlineData("100 000 009")]
   public void CaSocialInsightsNumber_ValidateWithCustomSeparator_ShouldCorrectlyWeightEvenPositionCharacters_WhenCalculatingLuhnCheckDigit(String sin)
      => CaSocialInsuranceNumber.Validate(sin, CustomSeparator).Should().Be(CaSocialInsuranceNumberValidationResult.ValidationPassed);
   ...
   [InlineData("100 800 002")]
   [InlineData("100 900 000")]
   public void CaSocialInsightsNumber_ValidateWithCustomSeparator_ShouldCorrectlyDoubleOddPositionCharacters_WhenCalculatingLuhnCheckDigit(String sin)
      => CaSocialInsuranceNumber.Validate(sin, CustomSeparator).Should().Be(CaSocialInsuranceNumberValidationResult.ValidationPassed);
   ...
   [InlineData("448 199 428")]   // 558199428 with two digit twin error 55 -> 44
   [InlineData("558 188 428")]   // 558199428 with two digit twin error 99 -> 88
   public void CaSocialInsightsNumber_ValidateWithCustomSeparator_ShouldReturnValidationPassed_WhenCheckDigitContainsDetectableError(String sin)
