...
public class UsNationalProviderIdentifierTests
{
   ...
   public void UsNationalProviderIdentifier_Constructor_ShouldThrowInvalidUsNationalProviderIdentifierException_WhenValueHasInvalidLength(String? sin)
      => FluentActions
         .Invoking(() => _ = new UsNationalProviderIdentifier(sin))
         .Should()
         .ThrowExactly<InvalidUsNationalProviderIdentifierException>()
   ...
   public void UsNationalProviderIdentifier_Constructor_ShouldThrowInvalidUsNationalProviderIdentifierException_WhenValueContainsNonAsciiDigit(String sin)
      => FluentActions
         .Invoking(() => _ = new UsNationalProviderIdentifier(sin))
         .Should()
         .ThrowExactly<InvalidUsNationalProviderIdentifierException>()
