...
public class FrDepartmentCodesTests
{
   #region GetAllDepartmentCodes Method Tests
   // ==========================================================================
   // ==========================================================================
   ...
   public void FrDepartmentCodes_GetAllDepartmentCodes_ShouldReturnFullListOfStateCodes()
   {
      ...
      [
         ...
         "91", "92", "93", "94", "95", "971", "972", "973", "974", "976", "99",
      ];
      ...
      // Assert.
      departmentCodes.Should().BeEquivalentTo(expectedDepartmentCodes);
   }
