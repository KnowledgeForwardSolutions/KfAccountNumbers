using LocalCreateResult = KfAccountNumbers.Results.CreateResult<
   KfAccountNumbers.National.Europe.GbHcNumber,
   KfAccountNumbers.National.Europe.GbHcNumber.ValidationError>;
using LocalValidationError = KfAccountNumbers.National.Europe.GbHcNumber.ValidationError;
using LocalValidationException = KfAccountNumbers.UKfValidationException<
   KfAccountNumbers.National.Europe.GbHcNumber.ValidationError>;
using LocalValidationResult = KfAccountNumbers.National.Europe.GbHcNumber.ValidationResult;
