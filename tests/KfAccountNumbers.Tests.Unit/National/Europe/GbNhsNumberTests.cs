using LocalCreateResult = KfAccountNumbers.Results.CreateResult<
   KfAccountNumbers.National.Europe.GbNhsNumber,
   KfAccountNumbers.National.Europe.GbNhsNumber.ValidationError>;
using LocalValidationError = KfAccountNumbers.National.Europe.GbNhsNumber.ValidationError;
using LocalValidationException = KfAccountNumbers.UKfValidationException<
   KfAccountNumbers.National.Europe.GbNhsNumber.ValidationError>;
using LocalValidationResult = KfAccountNumbers.National.Europe.GbNhsNumber.ValidationResult;
