using LocalCreateResult = KfAccountNumbers.Results.CreateResult<
   KfAccountNumbers.National.Europe.GbPatientNumber,
   KfAccountNumbers.National.Europe.GbPatientNumber.ValidationError>;
using LocalValidationError = KfAccountNumbers.National.Europe.GbPatientNumber.ValidationError;
using LocalValidationException = KfAccountNumbers.UKfValidationException<
   KfAccountNumbers.National.Europe.GbPatientNumber.ValidationError>;
using LocalValidationResult = KfAccountNumbers.National.Europe.GbPatientNumber.ValidationResult;
...
public class GbPatientNumberTests
{
      ...
      String separator)
   {
      ...
      LocalValidationResult expected = new InvalidDateOfBirth(
