...
using LocalCreateResult = KfAccountNumbers.Results.CreateResult<
   KfAccountNumbers.National.Europe.IePpsNumber,
   KfAccountNumbers.National.Europe.IePpsNumber.ValidationError>;
using LocalValidationError = KfAccountNumbers.National.Europe.IePpsNumber.ValidationError;
using LocalValidationException = KfAccountNumbers.UKfValidationException<
   KfAccountNumbers.National.Europe.IePpsNumber.ValidationError>;
using LocalValidationResult = KfAccountNumbers.National.Europe.IePpsNumber.ValidationResult;
