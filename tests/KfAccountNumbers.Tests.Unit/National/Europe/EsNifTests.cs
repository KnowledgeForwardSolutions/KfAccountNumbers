...
using LocalCreateResult = KfAccountNumbers.Results.CreateResult<
   KfAccountNumbers.National.Europe.EsNif,
   KfAccountNumbers.National.Europe.EsNif.ValidationError>;
using LocalValidationError = KfAccountNumbers.National.Europe.EsNif.ValidationError;
using LocalValidationException = KfAccountNumbers.UKfValidationException<
   KfAccountNumbers.National.Europe.EsNif.ValidationError>;
using LocalValidationResult = KfAccountNumbers.National.Europe.EsNif.ValidationResult;
