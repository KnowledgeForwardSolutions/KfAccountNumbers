...
using LocalCreateResult = KfAccountNumbers.Results.CreateResult<
   KfAccountNumbers.National.NorthAmerica.UsNationalProviderIdentifier,
   KfAccountNumbers.National.NorthAmerica.UsNationalProviderIdentifier.ValidationError>;
using LocalValidationError = KfAccountNumbers.National.NorthAmerica.UsNationalProviderIdentifier.ValidationError;
using LocalValidationException = KfAccountNumbers.UKfValidationException<
   KfAccountNumbers.National.NorthAmerica.UsNationalProviderIdentifier.ValidationError>;
using LocalValidationResult = KfAccountNumbers.National.NorthAmerica.UsNationalProviderIdentifier.ValidationResult;
