...
using LocalCreateResult = KfAccountNumbers.Results.CreateResult<
   KfAccountNumbers.National.NorthAmerica.UsIndividualTaxpayerIdentificationNumber,
   KfAccountNumbers.National.NorthAmerica.UsIndividualTaxpayerIdentificationNumber.ValidationError>;
using LocalValidationError = KfAccountNumbers.National.NorthAmerica.UsIndividualTaxpayerIdentificationNumber.ValidationError;
using LocalValidationException = KfAccountNumbers.UKfValidationException<
   KfAccountNumbers.National.NorthAmerica.UsIndividualTaxpayerIdentificationNumber.ValidationError>;
using LocalValidationResult = KfAccountNumbers.National.NorthAmerica.UsIndividualTaxpayerIdentificationNumber.ValidationResult;

namespace KfAccountNumbers.Tests.Unit.National.NorthAmerica;
