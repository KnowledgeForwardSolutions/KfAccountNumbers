...
using LocalCreateResult = KfAccountNumbers.Results.CreateResult<
   KfAccountNumbers.National.NorthAmerica.UsSocialSecurityNumber,
   KfAccountNumbers.National.NorthAmerica.UsSocialSecurityNumber.ValidationError>;
using LocalValidationError = KfAccountNumbers.National.NorthAmerica.UsSocialSecurityNumber.ValidationError;
using LocalValidationException = KfAccountNumbers.UKfValidationException<
   KfAccountNumbers.National.NorthAmerica.UsSocialSecurityNumber.ValidationError>;
using LocalValidationResult = KfAccountNumbers.National.NorthAmerica.UsSocialSecurityNumber.ValidationResult;
