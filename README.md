...
* National
	...
	- Europe
		...
		- [Spain - EsDni - Documento Nacional de Identidad](https://github.com/KnowledgeForwardSolutions/KfAccountNumbers/blob/main/docs/Reference/National/Europe/EsDni.md)
		- [Spain - EsNif - Número de Identificación Fiscal, composite type representing either Documento Nacional de Identidad (EsDni) or Número de Identificación de Extranjero (EsNie)](https://github.com/KnowledgeForwardSolutions/KfAccountNumbers/blob/main/docs/Reference/National/Europe/EsNif.md)
